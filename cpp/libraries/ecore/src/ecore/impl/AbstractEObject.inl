...
namespace ecore::impl
{
    ...
    template <typename... I>
    class AbstractEObject<I...>::EObjectInternalAdapter : public EObjectInternal {
    public:
        ...
        {
            return obj_.eDirectResource();
        }
        virtual std::shared_ptr<ENotificationChain> eSetResource(const std::shared_ptr<EResource>& resource, const std::shared_ptr<ENotificationChain>& notifications) override
        {
            return obj_.eSetResource(resource,notifications);
        }
        virtual std::shared_ptr<EObject> eObjectForFragmentSegment(const std::string& uriSegment) const override
        {
            return obj_.eObjectForFragmentSegment(uriSegment);
        }
        virtual std::string eURIFragmentSegment(const std::shared_ptr<EStructuralFeature>& feature, const std::shared_ptr<EObject>& eObject) const override
        {
            return obj_.eURIFragmentSegment(feature, eObject);
        }
        virtual std::shared_ptr<ENotificationChain> eInverseAdd(const std::shared_ptr<EObject>& otherEnd, int featureID, const std::shared_ptr<ENotificationChain>& notifications) override
        {
            return obj_.eInverseAdd(otherEnd, featureID, notifications);
        }
        virtual std::shared_ptr<ENotificationChain> eInverseRemove(const std::shared_ptr<EObject>& otherEnd, int featureID, const std::shared_ptr<ENotificationChain>& notifications) override
        {
            return obj_.eInverseRemove(otherEnd, featureID, notifications);
        }
        virtual URI eProxyURI() const override
        {
            return obj_.eProxyURI();
        }
        virtual void eSetProxyURI(const URI& uri) override
        {
            return obj_.eSetProxyURI(uri);
        }
        virtual std::shared_ptr<EObject> eResolveProxy(const std::shared_ptr<EObject>& proxy) const override
        {
            return obj_.eResolveProxy(proxy);
        }
    private:
    ...
    {
        return std::move( std::make_unique<EObjectInternalAdapter>(*this) );
    }
