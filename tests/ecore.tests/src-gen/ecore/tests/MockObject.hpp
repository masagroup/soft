...
namespace ecore::tests
{
    ...
    public:
        ...
        MOCK_METHOD_EXT(eGet ,1, boost::any(const std::shared_ptr<ecore::EStructuralFeature>&), eGet_EStructuralFeature) 
        MOCK_METHOD_EXT(eGet ,2, boost::any(const std::shared_ptr<ecore::EStructuralFeature>&,bool), eGet_EStructuralFeature_EBoolean) 
        MOCK_METHOD(eSet ,2) 
